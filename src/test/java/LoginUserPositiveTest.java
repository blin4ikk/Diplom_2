...
public class LoginUserPositiveTest {
    ...
    public void createNewUser() {
        Response responseCreate = createUser(user);
        responseCreate
                .then()
                .statusCode(200)
                .body("success", equalTo(true));
        accessToken = responseCreate.body().path("accessToken");
        ...
        responseLogin
                ...
                .statusCode(200)
                .body("success", equalTo(true));
        System.out.println("Пользователь: " + user.getMail() + "успешно залогинился");
    }
